...
export const TOOLS_REGISTRY: Tool[] = [
  ...
  },
  {
    ...
    description: "Test REST APIs and generate curl commands",
    tags: ["api", "rest", "curl", "http", "fetch"],
    category: "developer",
    path: "/tools/rest-client",
    icon: "Globe",
  },
  {
    id: "curl-builder",
    name: "CURL Builder",
    description: "Visually construct complex CURL commands",
    tags: ["curl", "terminal", "cli", "dev"],
    category: "developer",
